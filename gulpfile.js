...
const autoprefixer = require("autoprefixer");  //autoprefixer@9.7.1 only
const cleanCSS = require("gulp-clean-css");  
const postcss = require("gulp-postcss"); 

const dist = "D:/OpenServer/domains/siteWithAdminPanel/admin";  //change to ur dist (only for tests, the final version should be in the project folder)
const prod = "./build/";  //ur final version
...
gulp.task("watch", () => {
  ...
  gulp.watch("./app/api/**/*.*", gulp.parallel("copy-assets"));
...
gulp.task("prod", () => {  //to prod fin ver ur admin panel
