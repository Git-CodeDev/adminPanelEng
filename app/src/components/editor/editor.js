...
export default class Editor extends Component {
    ...
    open(page, cb) {
        ...
        axios
            ...
            .then(() => this.iframe.load("../p0№oSs__+cP@d11B0q.html"))  
    ...
    async save(onSuccess, onError) {
        ...
        await axios  
            ...
            .catch(() => this.showNotifications("Save error", "danger"))  
    ...
    restoreBackup(e, backup) {  
        ...
        UIkit.modal.confirm("Are you sure you want to restore the page from this backup? All unsaved data will be lost!",
    ...
    render() {
        ...
        if (!auth) {  
            return <Login login={this.login} lengthErr={loginLenghtError} logErr={loginError}/>
        }
        ...
        return(
            <>
                ...
                text={{
                    title: "Save",
                    descr: "Are you sure to save your changes?",
                    btn: "Publish"
                }}/>
                <ConfirmModal 
                modal={modal} 
                ...
                text={{
                    title: "Sign out",
                    descr: "Are you sure you want to sign out?",
                    btn: "Sign out"
                }}/>
